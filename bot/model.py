...
Обратить внимание: [указание на потенциальные риски для репутации компании, такие как неподобающие высказывания, агрессивное поведение или аморальный контент.Если ничего не найдено, напиши 'не обнаружено'].
```
Данные для анализа: 
```json
{data}
